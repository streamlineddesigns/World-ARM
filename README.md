...
The business relations officer of Color Switch gave me permission to include any of Color Switch's source code in this new game. The day he did that, I moved the sparse mixture of experts, the pieces of hyper associative recall memory, and many more important gameplay related features to the game. Yet, I never integrated any of it. Nothing stopped me from closing the loop on Rovios invention, and finally having the chance to observe automated KPI scaling. Black box reverse engineering corporate competitors revenue systems was a really fun thing I got to do. I could continue on.
...
While version 4 might never be tested, it does expand the cognitive architecture a step further. In homage to Jurgen Schmidhuber, I say thank you, and I think all of our jobs finally come to a close one day. Why didn't you add MCTS to your original world model paper? The same reason Craig Reynolds didn't add a Spatial Hash. The same reason ARM isn't end-end differentiable, or why I haven't swapped out the spatial hash for something more principled, and the same reason I'm not adding it to this paper other than say to its obvious that search is a necessary component. 
